...
//                       static_cast<size_t>(blockIdx.x), local_r, local_i, kerevals, vals_r,
//                       vals_i, shifts, typename Scatter::NativeBarrier{});
//     }
// #endif
//
//     // ─────────────────────────────────────────────────────────────────────────────
...
//                    + (GCplx && VCplx ? scratch_real_view::shmem_size(static_cast<size_t>(np)) :
//                    0)
//                    + scratch_int_view::shmem_size(static_cast<size_t>(np *
//                    static_cast<int>(Dim)));
//         }
//
//         // ── Arguments ─────────────────────────────────────────────────────────────
...
//                         const int idx0           = transform.getStencilBase(gp - RealType(0.5),
//                         W); shifts_sm[bi * idim + 0] = idx0 - args.local_offset[0] + half_left -
//                         tb0; for (int wi = 0; wi < W; ++wi)
...
//                         const int idx0           = transform.getStencilBase(gp - RealType(0.5),
//                         W); shifts_sm[bi * idim + 1] = idx0 - args.local_offset[1] + half_left -
//                         tb1; for (int wi = 0; wi < W; ++wi)
...
//                         const int idx0           = transform.getStencilBase(gp - RealType(0.5),
//                         W); shifts_sm[bi * idim + 2] = idx0 - args.local_offset[2] + half_left -
//                         tb2; for (int wi = 0; wi < W; ++wi)
...
//                      vals_r_v.data(), (gcplx && vcplx) ? vals_i_v.data() : nullptr,
//                      shifts_v.data(), KokkosBarrier{team});
//         }
//
//         void run(size_t n_particles);
//     };
